...
SetOutputFile[FileNameJoin[{Directory[], "Z4cowCarpet_set_rhs_freezeTheta_LazEvShift.hxx"}]];
...
SetMainPrint[
  ...
  PrintEquations[{Mode -> "Main", SuffixName -> "LazEvShift"}, Take[dtEvolVarlist, {-1}]];
  pr[];
