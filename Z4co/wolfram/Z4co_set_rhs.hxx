...
const auto dW1 = fd_1st(cctkGH, W, i, j, k, 1);
const auto dW2 = fd_1st(cctkGH, W, i, j, k, 2);
const auto dW3 = fd_1st(cctkGH, W, i, j, k, 3);
const auto dgamt111 = fd_1st(cctkGH, gamt11, i, j, k, 1);
const auto dgamt112 = fd_1st(cctkGH, gamt12, i, j, k, 1);
const auto dgamt113 = fd_1st(cctkGH, gamt13, i, j, k, 1);
const auto dgamt122 = fd_1st(cctkGH, gamt22, i, j, k, 1);
const auto dgamt123 = fd_1st(cctkGH, gamt23, i, j, k, 1);
const auto dgamt133 = fd_1st(cctkGH, gamt33, i, j, k, 1);
const auto dgamt211 = fd_1st(cctkGH, gamt11, i, j, k, 2);
const auto dgamt212 = fd_1st(cctkGH, gamt12, i, j, k, 2);
const auto dgamt213 = fd_1st(cctkGH, gamt13, i, j, k, 2);
const auto dgamt222 = fd_1st(cctkGH, gamt22, i, j, k, 2);
const auto dgamt223 = fd_1st(cctkGH, gamt23, i, j, k, 2);
const auto dgamt233 = fd_1st(cctkGH, gamt33, i, j, k, 2);
const auto dgamt311 = fd_1st(cctkGH, gamt11, i, j, k, 3);
const auto dgamt312 = fd_1st(cctkGH, gamt12, i, j, k, 3);
const auto dgamt313 = fd_1st(cctkGH, gamt13, i, j, k, 3);
const auto dgamt322 = fd_1st(cctkGH, gamt22, i, j, k, 3);
const auto dgamt323 = fd_1st(cctkGH, gamt23, i, j, k, 3);
const auto dgamt333 = fd_1st(cctkGH, gamt33, i, j, k, 3);
const auto dexKh1 = fd_1st(cctkGH, exKh, i, j, k, 1);
const auto dexKh2 = fd_1st(cctkGH, exKh, i, j, k, 2);
const auto dexKh3 = fd_1st(cctkGH, exKh, i, j, k, 3);
const auto dexAt111 = fd_1st(cctkGH, exAt11, i, j, k, 1);
const auto dexAt112 = fd_1st(cctkGH, exAt12, i, j, k, 1);
const auto dexAt113 = fd_1st(cctkGH, exAt13, i, j, k, 1);
const auto dexAt122 = fd_1st(cctkGH, exAt22, i, j, k, 1);
const auto dexAt123 = fd_1st(cctkGH, exAt23, i, j, k, 1);
const auto dexAt133 = fd_1st(cctkGH, exAt33, i, j, k, 1);
const auto dexAt211 = fd_1st(cctkGH, exAt11, i, j, k, 2);
const auto dexAt212 = fd_1st(cctkGH, exAt12, i, j, k, 2);
const auto dexAt213 = fd_1st(cctkGH, exAt13, i, j, k, 2);
const auto dexAt222 = fd_1st(cctkGH, exAt22, i, j, k, 2);
const auto dexAt223 = fd_1st(cctkGH, exAt23, i, j, k, 2);
const auto dexAt233 = fd_1st(cctkGH, exAt33, i, j, k, 2);
const auto dexAt311 = fd_1st(cctkGH, exAt11, i, j, k, 3);
const auto dexAt312 = fd_1st(cctkGH, exAt12, i, j, k, 3);
const auto dexAt313 = fd_1st(cctkGH, exAt13, i, j, k, 3);
const auto dexAt322 = fd_1st(cctkGH, exAt22, i, j, k, 3);
const auto dexAt323 = fd_1st(cctkGH, exAt23, i, j, k, 3);
const auto dexAt333 = fd_1st(cctkGH, exAt33, i, j, k, 3);
const auto dtrGt11 = fd_1st(cctkGH, trGt1, i, j, k, 1);
const auto dtrGt12 = fd_1st(cctkGH, trGt2, i, j, k, 1);
const auto dtrGt13 = fd_1st(cctkGH, trGt3, i, j, k, 1);
const auto dtrGt21 = fd_1st(cctkGH, trGt1, i, j, k, 2);
const auto dtrGt22 = fd_1st(cctkGH, trGt2, i, j, k, 2);
const auto dtrGt23 = fd_1st(cctkGH, trGt3, i, j, k, 2);
const auto dtrGt31 = fd_1st(cctkGH, trGt1, i, j, k, 3);
const auto dtrGt32 = fd_1st(cctkGH, trGt2, i, j, k, 3);
const auto dtrGt33 = fd_1st(cctkGH, trGt3, i, j, k, 3);
const auto dTheta1 = fd_1st(cctkGH, Theta, i, j, k, 1);
const auto dTheta2 = fd_1st(cctkGH, Theta, i, j, k, 2);
const auto dTheta3 = fd_1st(cctkGH, Theta, i, j, k, 3);
const auto dalpha1 = fd_1st(cctkGH, alpha, i, j, k, 1);
const auto dalpha2 = fd_1st(cctkGH, alpha, i, j, k, 2);
const auto dalpha3 = fd_1st(cctkGH, alpha, i, j, k, 3);
const auto dbeta11 = fd_1st(cctkGH, beta1, i, j, k, 1);
const auto dbeta12 = fd_1st(cctkGH, beta2, i, j, k, 1);
const auto dbeta13 = fd_1st(cctkGH, beta3, i, j, k, 1);
const auto dbeta21 = fd_1st(cctkGH, beta1, i, j, k, 2);
const auto dbeta22 = fd_1st(cctkGH, beta2, i, j, k, 2);
const auto dbeta23 = fd_1st(cctkGH, beta3, i, j, k, 2);
const auto dbeta31 = fd_1st(cctkGH, beta1, i, j, k, 3);
const auto dbeta32 = fd_1st(cctkGH, beta2, i, j, k, 3);
const auto dbeta33 = fd_1st(cctkGH, beta3, i, j, k, 3);
const auto ddW11 = fd_2nd(cctkGH, W, i, j, k, 1, 1);
const auto ddW12 = fd_2nd(cctkGH, W, i, j, k, 1, 2);
const auto ddW13 = fd_2nd(cctkGH, W, i, j, k, 1, 3);
const auto ddW22 = fd_2nd(cctkGH, W, i, j, k, 2, 2);
const auto ddW23 = fd_2nd(cctkGH, W, i, j, k, 2, 3);
const auto ddW33 = fd_2nd(cctkGH, W, i, j, k, 3, 3);
const auto ddgamt1111 = fd_2nd(cctkGH, gamt11, i, j, k, 1, 1);
const auto ddgamt1112 = fd_2nd(cctkGH, gamt12, i, j, k, 1, 1);
const auto ddgamt1113 = fd_2nd(cctkGH, gamt13, i, j, k, 1, 1);
const auto ddgamt1122 = fd_2nd(cctkGH, gamt22, i, j, k, 1, 1);
const auto ddgamt1123 = fd_2nd(cctkGH, gamt23, i, j, k, 1, 1);
const auto ddgamt1133 = fd_2nd(cctkGH, gamt33, i, j, k, 1, 1);
const auto ddgamt1211 = fd_2nd(cctkGH, gamt11, i, j, k, 1, 2);
const auto ddgamt1212 = fd_2nd(cctkGH, gamt12, i, j, k, 1, 2);
const auto ddgamt1213 = fd_2nd(cctkGH, gamt13, i, j, k, 1, 2);
const auto ddgamt1222 = fd_2nd(cctkGH, gamt22, i, j, k, 1, 2);
const auto ddgamt1223 = fd_2nd(cctkGH, gamt23, i, j, k, 1, 2);
const auto ddgamt1233 = fd_2nd(cctkGH, gamt33, i, j, k, 1, 2);
const auto ddgamt1311 = fd_2nd(cctkGH, gamt11, i, j, k, 1, 3);
const auto ddgamt1312 = fd_2nd(cctkGH, gamt12, i, j, k, 1, 3);
const auto ddgamt1313 = fd_2nd(cctkGH, gamt13, i, j, k, 1, 3);
const auto ddgamt1322 = fd_2nd(cctkGH, gamt22, i, j, k, 1, 3);
const auto ddgamt1323 = fd_2nd(cctkGH, gamt23, i, j, k, 1, 3);
const auto ddgamt1333 = fd_2nd(cctkGH, gamt33, i, j, k, 1, 3);
const auto ddgamt2211 = fd_2nd(cctkGH, gamt11, i, j, k, 2, 2);
const auto ddgamt2212 = fd_2nd(cctkGH, gamt12, i, j, k, 2, 2);
const auto ddgamt2213 = fd_2nd(cctkGH, gamt13, i, j, k, 2, 2);
const auto ddgamt2222 = fd_2nd(cctkGH, gamt22, i, j, k, 2, 2);
const auto ddgamt2223 = fd_2nd(cctkGH, gamt23, i, j, k, 2, 2);
const auto ddgamt2233 = fd_2nd(cctkGH, gamt33, i, j, k, 2, 2);
const auto ddgamt2311 = fd_2nd(cctkGH, gamt11, i, j, k, 2, 3);
const auto ddgamt2312 = fd_2nd(cctkGH, gamt12, i, j, k, 2, 3);
const auto ddgamt2313 = fd_2nd(cctkGH, gamt13, i, j, k, 2, 3);
const auto ddgamt2322 = fd_2nd(cctkGH, gamt22, i, j, k, 2, 3);
const auto ddgamt2323 = fd_2nd(cctkGH, gamt23, i, j, k, 2, 3);
const auto ddgamt2333 = fd_2nd(cctkGH, gamt33, i, j, k, 2, 3);
const auto ddgamt3311 = fd_2nd(cctkGH, gamt11, i, j, k, 3, 3);
const auto ddgamt3312 = fd_2nd(cctkGH, gamt12, i, j, k, 3, 3);
const auto ddgamt3313 = fd_2nd(cctkGH, gamt13, i, j, k, 3, 3);
const auto ddgamt3322 = fd_2nd(cctkGH, gamt22, i, j, k, 3, 3);
const auto ddgamt3323 = fd_2nd(cctkGH, gamt23, i, j, k, 3, 3);
const auto ddgamt3333 = fd_2nd(cctkGH, gamt33, i, j, k, 3, 3);
const auto ddalpha11 = fd_2nd(cctkGH, alpha, i, j, k, 1, 1);
const auto ddalpha12 = fd_2nd(cctkGH, alpha, i, j, k, 1, 2);
const auto ddalpha13 = fd_2nd(cctkGH, alpha, i, j, k, 1, 3);
const auto ddalpha22 = fd_2nd(cctkGH, alpha, i, j, k, 2, 2);
const auto ddalpha23 = fd_2nd(cctkGH, alpha, i, j, k, 2, 3);
const auto ddalpha33 = fd_2nd(cctkGH, alpha, i, j, k, 3, 3);
const auto ddbeta111 = fd_2nd(cctkGH, beta1, i, j, k, 1, 1);
const auto ddbeta112 = fd_2nd(cctkGH, beta2, i, j, k, 1, 1);
const auto ddbeta113 = fd_2nd(cctkGH, beta3, i, j, k, 1, 1);
const auto ddbeta121 = fd_2nd(cctkGH, beta1, i, j, k, 1, 2);
const auto ddbeta122 = fd_2nd(cctkGH, beta2, i, j, k, 1, 2);
const auto ddbeta123 = fd_2nd(cctkGH, beta3, i, j, k, 1, 2);
const auto ddbeta131 = fd_2nd(cctkGH, beta1, i, j, k, 1, 3);
const auto ddbeta132 = fd_2nd(cctkGH, beta2, i, j, k, 1, 3);
const auto ddbeta133 = fd_2nd(cctkGH, beta3, i, j, k, 1, 3);
const auto ddbeta221 = fd_2nd(cctkGH, beta1, i, j, k, 2, 2);
const auto ddbeta222 = fd_2nd(cctkGH, beta2, i, j, k, 2, 2);
const auto ddbeta223 = fd_2nd(cctkGH, beta3, i, j, k, 2, 2);
const auto ddbeta231 = fd_2nd(cctkGH, beta1, i, j, k, 2, 3);
const auto ddbeta232 = fd_2nd(cctkGH, beta2, i, j, k, 2, 3);
const auto ddbeta233 = fd_2nd(cctkGH, beta3, i, j, k, 2, 3);
const auto ddbeta331 = fd_2nd(cctkGH, beta1, i, j, k, 3, 3);
const auto ddbeta332 = fd_2nd(cctkGH, beta2, i, j, k, 3, 3);
const auto ddbeta333 = fd_2nd(cctkGH, beta3, i, j, k, 3, 3);
